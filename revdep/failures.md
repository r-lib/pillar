...
* Date/Publication: 2022-12-07 10:42:31 UTC
...
Run `revdepcheck::cloud_details(, "ggvis")` for more info
...
* checking whether package ‘modeltime.resample’ can be installed ... ERROR
Installation failed.
See ‘/tmp/workdir/modeltime.resample/old/modeltime.resample.Rcheck/00install.out’ for details.
* DONE
Status: 1 ERROR
...
Calls: <Anonymous> ... loadNamespace -> withRestarts -> withOneRestart -> doWithOneRestart
Execution halted
ERROR: lazy loading failed for package ‘rcontroll’
* removing ‘/tmp/workdir/rcontroll/new/rcontroll.Rcheck/rcontroll’
...
Execution halted
ERROR: lazy loading failed for package ‘rcontroll’
* removing ‘/tmp/workdir/rcontroll/old/rcontroll.Rcheck/rcontroll’
...
```
* installing *source* package ‘spDates’ ...
** package ‘spDates’ successfully unpacked and MD5 sums checked
** using staged installation
** R
** data
*** moving datasets to lazyload DB
** byte-compile and prepare package for lazy loading
Error: package or namespace load failed for ‘rcarbon’ in loadNamespace(i, c(lib.loc, .libPaths()), versionCheck = vI[[i]]):
 there is no package called ‘sf’
Execution halted
ERROR: lazy loading failed for package ‘spDates’
* removing ‘/tmp/workdir/spDates/new/spDates.Rcheck/spDates’
...
Execution halted
ERROR: lazy loading failed for package ‘spDates’
* removing ‘/tmp/workdir/spDates/old/spDates.Rcheck/spDates’
...
```
* installing *source* package ‘stxplore’ ...
** package ‘stxplore’ successfully unpacked and MD5 sums checked
** using staged installation
** R
** data
*** moving datasets to lazyload DB
...
Calls: <Anonymous> ... loadNamespace -> withRestarts -> withOneRestart -> doWithOneRestart
Execution halted
ERROR: lazy loading failed for package ‘stxplore’
* removing ‘/tmp/workdir/stxplore/new/stxplore.Rcheck/stxplore’
...
Execution halted
ERROR: lazy loading failed for package ‘stxplore’
* removing ‘/tmp/workdir/stxplore/old/stxplore.Rcheck/stxplore’
...
* Date/Publication: 2023-01-16 22:30:02 UTC
...
* this is package ‘wallace’ version ‘2.0.3’
* package encoding: UTF-8
* checking package namespace information ... OK
* checking package dependencies ... NOTE
...
