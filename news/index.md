...
- [`glimpse()`](https://pillar.r-lib.org/reference/glimpse.md) also
...
- [`print()`](https://rdrr.io/r/base/print.html) and
  ...
  [`tbl_format_setup()`](https://pillar.r-lib.org/reference/tbl_format_setup.md)
...
- Fix introductory example in
  [`vignette("extending")`](https://pillar.r-lib.org/articles/extending.md)
...
- New [`tbl_nrow()`](https://pillar.r-lib.org/reference/tbl_nrow.md)
  generic to support lazy data frames
  ([\#679](https://github.com/r-lib/pillar/issues/679)).

- Show missing values in red in
  [`glimpse()`](https://pillar.r-lib.org/reference/glimpse.md)
  ([@ryanzomorrodi](https://github.com/ryanzomorrodi),
  [\#662](https://github.com/r-lib/pillar/issues/662)).

- Math operations on
  [`num()`](https://pillar.r-lib.org/reference/num.md) objects now pass
  additional arguments to the mathematical function
...
- Math operations on
  [`num()`](https://pillar.r-lib.org/reference/num.md) objects no longer
  perform type checks. This allows, e.g., multiplying a
  [`num()`](https://pillar.r-lib.org/reference/num.md) with a logical
  ([\#630](https://github.com/r-lib/pillar/issues/630),
...
- [`colonnade()`](https://pillar.r-lib.org/reference/colonnade.md),
  [`extra_cols()`](https://pillar.r-lib.org/reference/extra_cols.md) and
  [`squeeze()`](https://pillar.r-lib.org/reference/squeeze.md) are now
  hard-deprecated ([\#272](https://github.com/r-lib/pillar/issues/272),
...
- Polish
  [`?pillar_options`](https://pillar.r-lib.org/reference/pillar_options.md)
...
- New
  [`ctl_new_rowid_pillar()`](https://pillar.r-lib.org/reference/ctl_new_pillar.md)
...
- [`ctl_new_pillar_list()`](https://pillar.r-lib.org/reference/ctl_new_pillar_list.md)
  is documented on a separate help page
  ([\#516](https://github.com/r-lib/pillar/issues/516)).

- Remove outdated detail in
  [`?tbl_sum`](https://pillar.r-lib.org/reference/tbl_sum.md)
...
- Soft-deprecate
  [`colonnade()`](https://pillar.r-lib.org/reference/colonnade.md),
  [`squeeze()`](https://pillar.r-lib.org/reference/squeeze.md) and
  [`extra_cols()`](https://pillar.r-lib.org/reference/extra_cols.md)
...
- [`colonnade()`](https://pillar.r-lib.org/reference/colonnade.md) is
  now soft-deprecated
  ([\#485](https://github.com/r-lib/pillar/issues/485)).
- [`expect_known_display()`](https://pillar.r-lib.org/reference/deprecated.md)
  and
  [`is_vector_s3()`](https://pillar.r-lib.org/reference/deprecated.md)
  are now deprecated
  ([\#460](https://github.com/r-lib/pillar/issues/460),
  [\#501](https://github.com/r-lib/pillar/issues/501)).
- [`new_pillar()`](https://pillar.r-lib.org/reference/new_pillar.md)
...
- Single pillars constructed with
  [`pillar()`](https://pillar.r-lib.org/reference/pillar.md) use only as
  much width as required when printing
...
- New
  [`scale_x_num()`](https://pillar.r-lib.org/reference/scale_x_num.md)
  and
  [`scale_y_num()`](https://pillar.r-lib.org/reference/scale_x_num.md).
  If a column created with
  [`num()`](https://pillar.r-lib.org/reference/num.md) is used in a
...
- [`new_pillar_shaft_simple()`](https://pillar.r-lib.org/reference/new_pillar_shaft.md)
...
- Default [`obj_sum()`](https://pillar.r-lib.org/reference/type_sum.md)
...
- [`?num`](https://pillar.r-lib.org/reference/num.md) and
  [`?char`](https://pillar.r-lib.org/reference/char.md) now point to
...
- [`num()`](https://pillar.r-lib.org/reference/num.md) requires an
...
- All pillars are shown with their true horizontal extent, irrespective
  ...
  [`pillar_shaft()`](https://pillar.r-lib.org/reference/pillar_shaft.md)
  methods ([\#347](https://github.com/r-lib/pillar/issues/347)).

### Features

- [`num()`](https://pillar.r-lib.org/reference/num.md) gains
...
- [`print.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md) and
  [`format.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md)
...
- [`obj_sum()`](https://pillar.r-lib.org/reference/type_sum.md) no
  longer calls
  [`type_sum()`](https://pillar.r-lib.org/reference/type_sum.md) for
...
- New [`num()`](https://pillar.r-lib.org/reference/num.md) and
  [`char()`](https://pillar.r-lib.org/reference/char.md) offer a
...
- New
  [`format_type_sum.AsIs()`](https://pillar.r-lib.org/reference/format_type_sum.md)
  avoids the need to implement your own
  [`format_type_sum()`](https://pillar.r-lib.org/reference/format_type_sum.md)
  method ([\#286](https://github.com/r-lib/pillar/issues/286)).
- [`align()`](https://pillar.r-lib.org/reference/align.md) gains `space`
  argument to control the character used for filling
...
- New
  [`vignette("numbers")`](https://pillar.r-lib.org/articles/numbers.md)
  and
  [`vignette("digits")`](https://pillar.r-lib.org/articles/digits.md)
  ([\#308](https://github.com/r-lib/pillar/issues/308)).
...
- New
  [`format_glimpse()`](https://pillar.r-lib.org/reference/format_glimpse.md)
...
- [`obj_sum()`](https://pillar.r-lib.org/reference/type_sum.md) now
  always returns a string.
  [`pillar_shaft.list()`](https://pillar.r-lib.org/reference/pillar_shaft.md)
  iterates over its elements and calls
  [`obj_sum()`](https://pillar.r-lib.org/reference/type_sum.md) for each
  ([\#137](https://github.com/r-lib/pillar/issues/137)).
...
- New [`size_sum()`](https://pillar.r-lib.org/reference/type_sum.md)
  generic ([\#239](https://github.com/r-lib/pillar/issues/239)).

- New
  [`ctl_new_pillar()`](https://pillar.r-lib.org/reference/ctl_new_pillar.md)
  and `ctl_new_compound_pillar()` used via
  [`print.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md),
  [`format.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md) and
  [`tbl_format_setup.tbl()`](https://pillar.r-lib.org/reference/tbl_format_setup.md)
  ([\#230](https://github.com/r-lib/pillar/issues/230)).

- New [`new_pillar()`](https://pillar.r-lib.org/reference/new_pillar.md)
  low-level constructor
  ([\#230](https://github.com/r-lib/pillar/issues/230)).

- New
  [`new_pillar_component()`](https://pillar.r-lib.org/reference/new_pillar_component.md)
  and
  [`pillar_component()`](https://pillar.r-lib.org/reference/new_pillar_component.md)
  ([\#230](https://github.com/r-lib/pillar/issues/230)).

- New articles
  [`vignette("extending")`](https://pillar.r-lib.org/articles/extending.md)
  and
  [`vignette("printing")`](https://pillar.r-lib.org/articles/printing.md)
...
- New experimental generics
  [`tbl_format_setup()`](https://pillar.r-lib.org/reference/tbl_format_setup.md),
  [`tbl_format_header()`](https://pillar.r-lib.org/reference/tbl_format_header.md),
  [`tbl_format_body()`](https://pillar.r-lib.org/reference/tbl_format_body.md)
  and
  [`tbl_format_footer()`](https://pillar.r-lib.org/reference/tbl_format_footer.md)
  ([\#179](https://github.com/r-lib/pillar/issues/179)).

- Move definition of
  [`tbl_sum()`](https://pillar.r-lib.org/reference/tbl_sum.md) to this
  package ([\#179](https://github.com/r-lib/pillar/issues/179)).
...
- Now using debugme to simplify understand the complex control flow, see
  [`vignette("debugme")`](https://pillar.r-lib.org/articles/debugme.md)
...
- Change internal storage format for
  [`colonnade()`](https://pillar.r-lib.org/reference/colonnade.md) and
  [`extra_cols()`](https://pillar.r-lib.org/reference/extra_cols.md)
...
- New [`align()`](https://pillar.r-lib.org/reference/align.md) to
...
- [`pillar_shaft()`](https://pillar.r-lib.org/reference/pillar_shaft.md),
  [`format_type_sum()`](https://pillar.r-lib.org/reference/format_type_sum.md)
  and [`extra_cols()`](https://pillar.r-lib.org/reference/extra_cols.md)
  issue a warning if dots are unused.

- [`new_pillar_title()`](https://pillar.r-lib.org/reference/new_pillar_title.md)
  and
  [`new_pillar_type()`](https://pillar.r-lib.org/reference/new_pillar_type.md)
...
- [`obj_sum()`](https://pillar.r-lib.org/reference/type_sum.md) uses
...
- [`type_sum()`](https://pillar.r-lib.org/reference/type_sum.md)
  forwards to
...
- The `class` argument to
  [`new_pillar_shaft()`](https://pillar.r-lib.org/reference/new_pillar_shaft.md)
...
- [`squeeze()`](https://pillar.r-lib.org/reference/squeeze.md) is now
  faster (because the width computation in
  [`pillar_shaft.numeric()`](https://pillar.r-lib.org/reference/pillar_shaft.md)
...
- Styling output is faster: an expensive check for availability of
  ...
  [`colonnade()`](https://pillar.r-lib.org/reference/colonnade.md), and
  styling is implemented manually
...
- [`pillar()`](https://pillar.r-lib.org/reference/pillar.md) no longer
  adds backticks if `title` is non-syntactic.
...
- [`colonnade()`](https://pillar.r-lib.org/reference/colonnade.md) now
  handles pillars named `"sep"`
  ([\#115](https://github.com/r-lib/pillar/issues/115)).
- [`pillar_shaft.character()`](https://pillar.r-lib.org/reference/pillar_shaft.md)
...
- New styling helper
  [`style_subtle_num()`](https://pillar.r-lib.org/reference/style_subtle.md),
