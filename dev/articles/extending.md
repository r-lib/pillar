...
[`tbl_sum()`](https://pillar.r-lib.org/dev/reference/tbl_sum.md) method
to extend or replace the information shown in the header, keeping the
original formatting.
...
[`tbl_sum()`](https://pillar.r-lib.org/dev/reference/tbl_sum.md) and can
