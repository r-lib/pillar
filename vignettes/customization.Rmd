...
- Rethink `new_pillar_component()` and `pillar_component()`, closer coupling with `new_ornament()`?
    - Boxes and ornaments are different concepts: a component is used to describe the components of a pillar, an ornament has the contents of a shaft (or of another component)
