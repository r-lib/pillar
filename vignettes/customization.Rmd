...
- For each column we could possibly fit, we call the `new_pillar_capital()` method and query the minimum width, until maximum width is reached.
- For each column where the capital fits, we call the `new_pillar_shaft()` method and query the minimum width, until maximum width is reached.
