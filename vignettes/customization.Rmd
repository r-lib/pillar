...
- Finish documentation of `.Rmd` and functions
    - Explain how to show the control flow with debugme
    - Hide code in `<details>`, pretty-print, keep source
- Finish walkthrough `.Rmd` to show extension points:
    - Construct separate class for each example
