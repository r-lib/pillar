...
The `ctl_new_compound_pillar()` generic dispatches over the container:
...
It is possible to change the appearance of pillars by overriding or extending `ctl_new_pillar()`, see the next section for details.
