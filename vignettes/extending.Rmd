...
The `"custom"` class doesn't have any customizations yet, and prints like a regular tibble.
...
### Tweak display of compund pillars
...
tbl_format_body.oldskool <- function(x, setup, ...) {
  capture.output(print.data.frame(head(x, setup$rows_body)))
}
