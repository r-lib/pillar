...
Formatting a
[colonnade](https://pillar.r-lib.org/reference/colonnade.md) object may
lead to some columns being omitted due to width restrictions. This
...
- x:
  ...
  The result of
  [`squeeze()`](https://pillar.r-lib.org/reference/squeeze.md) on a
  [colonnade](https://pillar.r-lib.org/reference/colonnade.md) object
