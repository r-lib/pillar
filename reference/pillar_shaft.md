...
- sigfig:
  ...
  Deprecated, use [`num()`](https://pillar.r-lib.org/reference/num.md)
  or [`set_num_opts()`](https://pillar.r-lib.org/reference/num.md) on
  the data instead.

- min_width:

  Deprecated, use [`char()`](https://pillar.r-lib.org/reference/char.md)
  or [`set_char_opts()`](https://pillar.r-lib.org/reference/char.md) on
  the data instead.
