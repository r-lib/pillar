...
[`format.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md). This
method collects information that is common to the header, body, and
...
- ...:
  ...
  Extra arguments to
  [`print.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md) or
...
- n:
  ...
  [options](https://pillar.r-lib.org/reference/pillar_options.md) should
  be considered by implementations of this method.
