# output test
    ...
    Output
      ...
      # A data frame: 3 x 3
      <tbl_format_body(setup)>
        column_zero_zero `col 0~` $`c~` $`co~ `co~`
                   <dbl> <chr>    <chr> <int> <ord>
      1             1.23 a        A         1 a    
      2             2.23 b        B         2 b    
      3             3.23 c        C         3 c    
    ...
    Output
      ...
      # A data frame: 3 x 3
      <tbl_format_body(setup)>
        column_zero_zero `col 01~` $`c~` $`co~ `co~`
                   <dbl> <chr>     <chr> <int> <ord>
      1             1.23 a         A         1 a    
      2             2.23 b         B         2 b    
      3             3.23 c         C         3 c    
    ...
    Output
      ...
      # A data frame: 3 x 3
      <tbl_format_body(setup)>
        column_zero_zero `col 01`$`c~` $`c~` $`co~ `co~`
                   <dbl> <chr>         <chr> <int> <ord>
      1             1.23 a             A         1 a    
      2             2.23 b             B         2 b    
      3             3.23 c             C         3 c    
    ...
    Output
      ...
      # A data frame: 3 x 3
      <tbl_format_body(setup)>
        column_zero_zero `col 01`$`co~` $`c~` $`co~ `co~`
                   <dbl> <chr>          <chr> <int> <ord>
      1             1.23 a              A         1 a    
      2             2.23 b              B         2 b    
      3             3.23 c              C         3 c    
    ...
    Output
      ...
      # A data frame: 3 x 3
      <tbl_format_body(setup)>
        column_zero_zero `col 01`$`col~` $`c~` $`co~ `co~`
                   <dbl> <chr>           <chr> <int> <ord>
      1             1.23 a               A         1 a    
      2             2.23 b               B         2 b    
      3             3.23 c               C         3 c    
    ...
    Output
      ...
      # A data frame: 3 x 3
      <tbl_format_body(setup)>
        column_zero_zero `col 01`$`col 02` $`c~` $`co~ `co~`
                   <dbl> <chr>             <chr> <int> <ord>
      1             1.23 a                 A         1 a    
      2             2.23 b                 B         2 b    
      3             3.23 c                 C         3 c    
