# output test
    ...
    Output
      ...
      # * 3 more variables: column_zero_zero <dbl>, `col 01` <tbl[,3]>, `col 05` <ord>
    Code
    ...
    Output
      ...
      3             3.23 c          C       c      
      <tbl_format_footer(setup)>
      # * abbreviated names: 1: `col 01`$`col 02`,
      #   2: $`col 03`, 3: `col 05`
      # * 1 more variable:
      #   `col 01`$`col 04` <int[,3]>
    Code
    ...
    Output
      ...
      # * abbreviated names: 1: `col 01`$`col 02`,
      #   2: $`col 03`, 3: `col 05`
      # * 1 more variable: `col 01`$`col 04` <int[,3]>
    Code
    ...
    Output
      ...
      3             3.23 c               C              3 c      
      <tbl_format_footer(setup)>
      # * abbreviated names: 1: `col 01`$`col 02`, 2: $`col 03`,
      #   3: $`col 04`[,"A"], 4: `col 05`
      # * 1 more variable: `col 01`$`col 04`[2:3] <int>
    Code
    ...
    Output
      ...
      3             3.23 c                 C             3 c      
      <tbl_format_footer(setup)>
      # * abbreviated names: 1: $`col 03`, 2: $`col 04`[,"A"],
      #   3: `col 05`
      # * 1 more variable: `col 01`$`col 04`[2:3] <int>
    Code
    ...
    Output
      ...
      3             3.23 c                 C               3 c      
      <tbl_format_footer(setup)>
      # * abbreviated names: 1: $`col 04`[,"A"], 2: `col 05`
      # * 1 more variable: `col 01`$`col 04`[2:3] <int>
    Code
...
# tbl_format_setup() for footnotes
    ...
    Output
      ...
      <tbl_format_footer(setup)>
      # * 4 more variables: xxxefg <dbl>, xxxhij <dbl>, xxxklm <dbl>,
      #   xxxnop <dbl>
