# output test
    ...
    Output
      ...
      #   with 3 more variables not shown: column_zero_zero <dbl>, `col 01` <tbl[,3]>, `col 05` <ord>
    Code
    ...
    Output
      ...
      3             3.23 c                
      <tbl_format_footer(setup)>
      # ... with 3 more variables not shown:
      #   `col 01`$`col 03` <chr>,
      #   `col 01`$`col 04` <tbl[,2]>,
      #   `col 05` <ord>
    Code
    ...
    Output
      ...
      3             3.23 c                c       
      <tbl_format_footer(setup)>
      # ... with 2 more variables not shown:
      #   `col 01`$`col 03` <chr>,
      #   `col 01`$`col 04` <tbl[,2]>
    Code
    ...
    Output
      ...
      3             3.23 c                C         c           c       
      <tbl_format_footer(setup)>
      # ... with 1 more variable not shown: `col 01`$`col 04`$b <int>
    Code
