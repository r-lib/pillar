...
---
    ...
    Code
      options(width = 42)
    Code
      ctl_colonnade(df_str[c(28L, 41L, 12L, 29L, 13L, 43L,
        24L, 50L, 48L, 35L, 44L, 21L, 33L, 45L, 47L, 34L,
        25L, 14L, 18L, 23L, 7L, 3L, 42L, 36L, 11L, 2L, 20L,
        31L, 1L, 4L, 38L, 9L, 27L, 40L, 32L, 17L, 6L, 49L,
        16L, 19L, 15L, 22L, 39L, 10L, 46L, 5L, 30L, 8L, 26L,
        37L)], width = 1365)
    Output
        `28`                        
        <chr>                       
...
---
    ...
    Code
      options(width = 39)
    Code
      ctl_colonnade(df_str[c(40L, 17L, 13L, 23L,
...
---
    ...
    Code
      options(width = 32)
    Code
      ctl_colonnade(df_str[c(11L, 36L, 17L,
        14L, 31L, 35L, 23L, 13L, 6L, 44L,
        45L, 22L, 21L, 18L, 33L, 10L, 43L,
        2L, 46L, 34L, 3L, 19L, 1L, 38L, 9L,
        37L, 5L, 8L, 25L, 49L, 27L, 29L, 15L,
        39L, 24L, 40L, 48L, 26L, 47L, 42L,
        41L, 12L, 28L, 30L, 7L, 16L, 4L, 50L,
        20L, 32L)], width = 565)
    Output
        `11`       
        <chr>      
...
---
    ...
    Code
      options(width = 35)
    Code
      ctl_colonnade(df_str[c(18L, 46L,
...
---
    ...
    Code
      options(width = 32)
    Code
      ctl_colonnade(df_str[c(43L, 1L, 3L,
...
---
    ...
    Code
      options(width = 31)
    Code
      ctl_colonnade(df_str[c(37L, 46L,
...
---
    ...
    Code
      options(width = 58)
    Code
      ctl_colonnade(df_str[c(31L,
        39L, 40L, 30L, 10L, 21L, 9L,
        16L, 46L, 25L, 15L, 24L, 3L,
        50L, 35L, 1L, 12L, 34L, 48L,
        4L, 29L, 23L, 37L, 36L, 28L,
        43L, 11L, 17L, 32L, 8L, 41L,
        13L, 44L, 7L, 38L, 26L, 33L,
        20L, 19L, 2L, 18L, 49L, 27L,
        47L, 22L, 14L, 6L, 5L, 45L,
        42L)], width = 546)
    Output
        `31`                           
        <chr>                          
...
---
    ...
    Code
      options(width = 57)
    Code
      ctl_colonnade(df_str[c(43L, 21L, 41L, 48L, 22L, 25L, 2L,
        8L, 1L, 24L, 6L, 39L, 38L, 20L, 49L, 45L, 47L, 12L, 9L,
        13L, 36L, 26L, 44L, 11L, 46L, 28L, 7L, 18L, 50L, 16L,
        29L, 30L, 4L, 23L, 17L, 40L, 33L, 14L, 27L, 19L, 34L,
        32L, 3L, 37L, 15L, 10L, 5L, 35L, 31L, 42L)], width = 1035)
    Output
        `43`                                       
        <chr>                                      
...
---
    ...
    Code
      options(width = 33)
    Code
      ctl_colonnade(df_str[c(40L, 6L, 25L, 5L, 26L, 17L, 19L,
        2L, 11L, 34L, 45L, 24L, 22L, 44L, 35L, 7L, 4L, 49L, 1L,
        36L, 12L, 41L, 39L, 13L, 48L, 27L, 18L, 30L, 42L, 28L,
        3L, 46L, 21L, 20L, 16L, 29L, 50L, 10L, 9L, 8L, 47L,
        31L, 14L, 38L, 33L, 32L, 43L, 23L, 15L, 37L)], width = 1217)
    Output
        `40`                           
        <chr>                          
...
---
    ...
    Code
      options(width = 32)
    Code
      ctl_colonnade(df_str[c(43L, 23L,
        22L, 11L, 6L, 26L, 48L, 17L,
        7L, 42L, 36L, 21L, 35L, 50L,
        13L, 19L, 29L, 8L, 15L, 4L, 2L,
        27L, 49L, 47L, 30L, 31L, 25L,
        28L, 46L, 12L, 32L, 39L, 24L,
        10L, 45L, 5L, 37L, 14L, 40L,
        20L, 41L, 44L, 33L, 18L, 38L,
        3L, 1L, 34L, 16L, 9L)], width = 770)
    Output
        `43`                          
        <chr>                         
      1 AbcdefghijAbcdefghijAbcdefghi~
...
---
    ...
    Code
      options(width = 46)
    Code
      ctl_colonnade(df_str[c(5L, 24L,
        43L, 46L, 35L, 39L, 18L, 26L,
        8L, 27L, 2L, 50L, 6L, 14L,
        29L, 47L, 9L, 16L, 36L, 4L,
        13L, 41L, 3L, 28L, 37L, 33L,
        38L, 31L, 34L, 19L, 42L, 32L,
        1L, 45L, 15L, 7L, 11L, 49L,
        23L, 12L, 48L, 20L, 21L, 44L,
        25L, 10L, 22L, 30L, 40L, 17L)],
      width = 1439)
    Output
        `5`   `24`                    
        <chr> <chr>                   
...
---
    ...
    Code
      options(width = 52)
    Code
      ctl_colonnade(df_str[c(7L, 44L, 19L, 21L, 18L,
        35L, 23L, 50L, 33L, 37L, 25L, 26L, 10L, 39L,
        2L, 47L, 42L, 14L, 9L, 41L, 45L, 6L, 4L,
        11L, 24L, 43L, 32L, 3L, 38L, 5L, 49L, 27L,
        17L, 8L, 22L, 40L, 12L, 15L, 1L, 28L, 31L,
        29L, 13L, 48L, 34L, 36L, 30L, 20L, 16L, 46L)],
      width = 1065)
    Output
        `7`    
        <chr>  
...
---
    ...
    Code
      options(width = 35)
    Code
      ctl_colonnade(df_str[c(38L, 18L, 23L, 36L, 35L, 20L,
        44L, 19L, 13L, 41L, 31L, 7L, 11L, 29L, 2L, 14L,
        26L, 46L, 40L, 45L, 9L, 34L, 33L, 22L, 1L, 17L,
        28L, 10L, 21L, 30L, 47L, 49L, 6L, 12L, 4L, 25L,
        32L, 15L, 43L, 24L, 48L, 3L, 37L, 50L, 42L, 39L,
        16L, 8L, 27L, 5L)], width = 393)
    Output
        `38`                             
        <chr>                            
      1 AbcdefghijAbcdefghijAbcdefghijAb~
...
---
    ...
    Code
      options(width = 41)
    Code
      ctl_colonnade(df_str[c(22L, 9L,
        11L, 26L, 19L, 16L, 32L, 25L, 1L,
        30L, 31L, 6L, 24L, 10L, 39L, 21L,
        50L, 7L, 29L, 12L, 46L, 43L, 15L,
        35L, 20L, 40L, 49L, 38L, 36L,
        48L, 34L, 3L, 8L, 4L, 27L, 42L,
        44L, 33L, 45L, 18L, 5L, 2L, 13L,
        47L, 28L, 17L, 37L, 14L, 41L,
        23L)], width = 999)
    Output
        `22`                   `9`      
        <chr>                  <chr>    
