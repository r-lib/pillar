...
tables. The
[`print.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md) method
calls [`format()`](https://rdrr.io/r/base/format.html) for the object
...
The [`format.tbl()`](https://pillar.r-lib.org/reference/format_tbl.md)
...
1.  Create a pillar object for every top-level column that fits, using
    ...
    and ultimately
    [`pillar()`](https://pillar.r-lib.org/reference/pillar.md) and
...
[`pillar()`](https://pillar.r-lib.org/reference/pillar.md) directly,
...
with [`new_pillar()`](https://pillar.r-lib.org/reference/new_pillar.md).
