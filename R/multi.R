...
colonnade_get_width <- function(x, width, rowid_width) {
  ...
  col_widths_df <- colonnade_compute_chunked_col_widths_df(col_df, width, rowid_width)
...
#' @usage NULL
#' @aliases NULL
colonnade_compute_chunked_col_widths_df <- function(col_df, width, rowid_width) {
